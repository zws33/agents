...
description: Activate the prompt architect persona to improve a repository instruction file for coding agents (AGENTS.md / CLAUDE.md). Use this when the user wants to audit, tighten, or rewrite an agent instruction file.
---
...
- If the user names a file (e.g., `prompt-architect CLAUDE.md`), use it.
